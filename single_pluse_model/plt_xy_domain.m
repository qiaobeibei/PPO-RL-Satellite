% 定义两个椭圆的参数
data = [5.4874885e+06, -5.2016965e+06, 5.0575192e+07, 5.0642520e+07, 3.4279218e+00, ...
        -3.6322158e+06, 2.6284132e+06, 3.6821004e+07, 3.6620276e+07, -2.3815693e+01];

% 拆分数据
ellipse1_params = data(1:5);
ellipse2_params = data(6:10);

% 提取第一个椭圆的参数
xc1 = ellipse1_params(1);
yc1 = ellipse1_params(2);
a1 = ellipse1_params(3);
b1 = ellipse1_params(4);
theta1 = ellipse1_params(5);

% 提取第二个椭圆的参数
xc2 = ellipse2_params(1);
yc2 = ellipse2_params(2);
a2 = ellipse2_params(3);
b2 = ellipse2_params(4);
theta2 = ellipse2_params(5);

% 生成椭圆的点
t = linspace(0, 2 * pi, 100);

% 第一个椭圆
Ell1 = [a1 * cos(t); b1 * sin(t)];
...
% 绘制第一个椭圆并添加黑色斜线填充
h1 = fill(x1, y1, 'w', 'EdgeColor', 'none');
hatchfill2(h1, 'single', 'HatchAngle', 45, 'HatchDensity', 20, 'HatchColor', 'k');

% 绘制第二个椭圆并填充白色
fill(x2, y2, 'w', 'EdgeColor', 'none');

% 绘制第二个椭圆边界
plot(x2, y2, 'k', 'LineWidth', 0.8);
